    ...
    <div style={{ fontFamily: "Arial, sans-serif", maxWidth: 960, margin: "0 auto", padding: "2rem" }}>
          ...
          <Section title="🚢 Shipment & Trade Details">
            ...
            <Row>
              <Field label="Incoterms">
                <select className="border p-2 rounded" value={form.incoterms} onChange={(e) => set("incoterms", e.target.value)}>
              ...
              <div key={item.id} style={{ border: "1px solid #ddd", borderRadius: 8, padding: 14, marginBottom: 12, background: "#fafafa" }}>
                ...
                <Row>
                  ...
                  <Field label="No. of Packages">
                    <input className="border p-2 rounded" type="number" value={item.noOfPkgs} onChange={(e) => setItem(idx, "noOfPkgs", e.target.value)} placeholder="17 Cartons" />
                  </Field>
                </Row>
                <Row>
                  <Field label="Quantity (Nos)" required>
                    <input className="border p-2 rounded" type="number" value={item.qty} onChange={(e) => setItem(idx, "qty", e.target.value)} placeholder="850" />
                  </Field>
                  <Field label="Unit">
                    <select className="border p-2 rounded" value={item.unit} onChange={(e) => setItem(idx, "unit", e.target.value)}>
          ...
          <Section title="📋 Packing Details">
            <Row>
              ...
              <Field label="No. of Cartons">
                <input className="border p-2 rounded" type="number" value={form.noOfCartons} onChange={(e) => set("noOfCartons", e.target.value)} placeholder="17" />
              </Field>
              <Field label="Units per Carton">
                <input className="border p-2 rounded" type="number" value={form.unitsPerCarton} onChange={(e) => set("unitsPerCarton", e.target.value)} placeholder="50" />
              </Field>
            </Row>
            <Row>
              <Field label="Net Wt per Unit (g)">
                <input className="border p-2 rounded" type="number" value={form.netWtPerUnit} onChange={(e) => set("netWtPerUnit", e.target.value)} placeholder="500" />
              </Field>
              <Field label="Net Wt per Carton (kg)">
                <input className="border p-2 rounded" type="number" value={form.netWtPerCarton} onChange={(e) => set("netWtPerCarton", e.target.value)} placeholder="25" />
              </Field>
              <Field label="Gross Wt per Carton (kg)">
                <input className="border p-2 rounded" type="number" value={form.grossWtPerCarton} onChange={(e) => set("grossWtPerCarton", e.target.value)} placeholder="26.40" />
              </Field>
            </Row>
            {totalNetWt > 0 && (
      ...
      {view === "print" && (
        <div className="flex flex-col items-center">
          ...
          <div ref={printRef} style={{ background: "#fff", border: "1px solid #ccc", borderRadius: 8, padding: 28, fontFamily: "Arial, sans-serif", fontSize: 11, color: "#000", width: "100%", maxWidth: 860 }}>
            {/* Header */}
