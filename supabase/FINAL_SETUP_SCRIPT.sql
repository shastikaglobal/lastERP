...
-- just like you did with the first script!
-- ==========================================================

-- 1. Grant Permissions to the Views so the dashboard can read them
...
-- 2. Disable Row Level Security so the customer can see the demo data
...
-- 3. Insert the fake seed data into the database
DO $$
DECLARE
